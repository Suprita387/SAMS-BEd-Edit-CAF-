...
public class EligibilityCriteriaForPHArts extends BaseClass implements BEdData {
	...
	public void Login() throws Exception {
		...
		bc.Login(MobileNumberArtsPH, Password);
		Thread.sleep(3000);
	...
	public void ArtsWithLessThan45PercentageInGraduation() throws Exception {
		...
		if (msg.equals("Please enter PG Details if you have secured less than 45 Percentage in Graduation")) {
			...
			constants.fileone.setCellData(sheetName, "Status", 42, "Pass");
		} else {
			constants.fileone.setCellData(sheetName, "Status", 42, "Fail");
		}
		SoftAssert softAssert = new SoftAssert();
