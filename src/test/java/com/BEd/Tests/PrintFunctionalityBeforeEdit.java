...
public class PrintFunctionalityBeforeEdit extends BaseClass implements BEdData {
	...
	public void PrintFunctionality() throws Exception {
		...
		if (Course.equalsIgnoreCase(SelectCourse2) && ApplicantType.equalsIgnoreCase(ApplicantType1)
				...
				&& MobNo.equals("8249816001")&& MartialStatuss.equalsIgnoreCase("UNMARRIED") && Quotaa.equalsIgnoreCase(QuotaS)
				&& HigherSecondaryy.equals("Appeared") && Addresss1.equals(Add1) && Addresss2.equals(Add2)
				...
				&& RollNo.equals("ABC12345") && Max.equals(TenthMaxMark) && Sec.equals("450")
				&& TwelthExam.equalsIgnoreCase("+2") && TwelthCollegeBoard.equalsIgnoreCase(TwelthBoardName)
				&& TwelthExamType.equals("Annual") && TwelthYOPP.equals(TwelthYOP) && TwelthRollNo.equals("DEF23456")
				&& TwelthMax.equals(TenthMaxMark) && TwelthSec.equals("425")&& GraduationExam.equalsIgnoreCase("Graduation")
				&& GraduationCollegeBoard.equalsIgnoreCase(GraduationBoardName) && GraduationExamType.equals("Annual")
				&& GraduationYOPP.equals(GraduationYOP) && GraduationRollNo.equals("GHI34567")&& GraduationMax.equals("") && GraduationSec.equals("")) {
