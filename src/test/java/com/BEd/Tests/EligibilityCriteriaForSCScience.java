...
public class EligibilityCriteriaForSCScience extends BaseClass implements BEdData {
	...
	public void Login() throws Exception {
		...
		bc.Login(MobileNumberScienceSC, Password);
		Thread.sleep(3000);
	...
	public void ScienceWithMoreThan45PercentageInPG() throws Exception {
		...
		ExtentFactory.getInstance().getExtent().info("Successfully checked Science With More Than 45 Percentage In PG scenario");
	}
	...
	public void ScienceWithLessThan45PercentageInPG() throws Exception {
		...
		ExtentFactory.getInstance().getExtent().info("Successfully checked Science With less than 45 Percentage In PG scenario");
	}
