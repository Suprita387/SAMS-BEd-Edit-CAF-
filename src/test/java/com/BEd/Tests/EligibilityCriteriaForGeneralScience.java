...
public class EligibilityCriteriaForGeneralScience extends BaseClass implements BEdData {
	...
	@Test(priority = 1)
	public void ScienceWithMoreThan50PercentageInPG() throws Exception {
		...
		Thread.sleep(1000);
		ExtentFactory.getInstance().getExtent().info("Entering more than 50 percentage marks in PG");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully checked Science With More Than 50 Percentage In PG scenario");
	}

	@Test(priority = 2)
	public void ScienceWithLessThan50PercentageInPG() throws Exception {
		...
		Form.PGObtainedMark().clear();
		Form.PGObtainedMark().sendKeys(SecuredMarkL50);
		Thread.sleep(1000);
		Form.Submit().click();
		Thread.sleep(600);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully checked Science With less than 50 Percentage In PG scenario");
	}
